...
const rows = [
  ...
  { date: '11/04/2019', redirects: 123},
  { date: '10/04/2019', redirects: 123},
  { date: '08/04/2019', redirects: 123},
  { date: '07/04/2019', redirects: 123},
  { date: '03/04/2019', redirects: 123},
  { date: '03/04/2019', redirects: 123},
  { date: '07/04/2019', redirects: 123},
  { date: '03/04/2019', redirects: 123},
  { date: '03/04/2019', redirects: 123},
...
const headRows = [
  ...
  { id: 'redirects', numeric: true, disablePadding: false, label: 'Redirects' },
];
                ...
                .map((row, index) => {
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">{row.redirects}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
